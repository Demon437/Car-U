...
const EMICalculator = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="pt-12 pb-20 bg-gradient-to-b from-white to-red-50">
        <div className="container mx-auto px-4">
          <Link
            to="/"
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-500 text-lg">
                Plan your car purchase with our easy-to-use finance tool.
              </p>
            </div>

            {/* MAIN CARD */}
            <div className="grid md:grid-cols-2 gap-12 p-8 md:p-12 rounded-[2rem] bg-white border border-red-100 shadow-xl">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <Label className="text-base">Tenure (Months)</Label>
                    <span className="font-bold text-red-600">{tenure} Months</span>
                  </div>
                  <Slider
                    value={[tenure]}
                    onValueChange={([val]) => setTenure(val)}
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <Label className="text-base">Interest Rate (%)</Label>
                    <span className="font-bold text-red-600">{interestRate}%</span>
                  </div>
                  <Slider
                    value={[interestRate]}
                    onValueChange={([val]) => setInterestRate(val)}
              ...
              {/* Results */}
              <div className="flex flex-col justify-center space-y-6">
                <div className="bg-gradient-to-r from-gray-600 to-red-300 p-8 rounded-2xl text-center text-white shadow-lg">
                ...
                <div className="flex items-start gap-3 p-4 bg-red-50 rounded-xl border border-red-100">
                  ...
                  <p className="text-xs text-gray-600">
                    *This is an estimate. Actual EMI may vary based on bank terms,
                    credit score, and processing fees.
                  </p>
                </div>

                <Button
                  size="xl"
                  className="w-full text-lg h-14 bg-red-500 hover:bg-red-700 text-white"
                  asChild
                >
                  <Link to="/contact">Apply for Finance</Link>
                </Button>
